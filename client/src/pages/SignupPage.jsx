  ...
  return (
    <div className="min-h-screen bg-surface-light flex items-center justify-center py-16 px-4 font-sans text-left">
      <div className="w-full max-w-2xl text-left">
        <div className="card-bg rounded-2xl shadow-2xl overflow-hidden">
          {/* Header */}
          <div className="bg-gradient-to-r from-slate-900 to-slate-800 px-10 py-8 text-left">
            ...
            <p className="text-gray-400 text-sm">
              Join the ROCA Living landlord partner portal
            </p>
          </div>
          ...
          <form onSubmit={handleSignup} className="p-8 sm:p-10 space-y-5">
            ...
            <div className="flex items-start gap-3 pt-1 text-left">
              ...
              <label
                ...
                className="text-sm text-status-muted leading-relaxed cursor-pointer select-none"
              >
                I agree to the{" "}
                <Link
            ...
            <p className="text-center text-sm text-status-muted pt-2">
