...
const TenancyLifecycle = lazy(() => import('./pages/TenancyLifecycle').then(m => ({ default: m.TenancyLifecycle })));
          ...
          <AuthProvider>
            <Suspense fallback={<LoadingSkeleton lines={6} />}>
              <Routes>
                ...
                <Route element={<ProtectedRoute><PropertyProvider><LandlordLayout /></PropertyProvider></ProtectedRoute>}>
                  ...
                  <Route path="/compliance/tenant" element={<ComingSoon title="Tenant Compliance" />} />
                  <Route path="/compliance/landlord" element={<ComingSoon title="Landlord Compliance" />} />
                  <Route path="/compliance/certificates" element={<Certificates />} />
                  <Route path="/compliance/inspections" element={<Inspections />} />
                  <Route path="/maintenance" element={<Maintenance />} />
                  <Route path="/tenancy" element={<TenancyLifecycle />} />
                  <Route path="/utilities" element={<ComingSoon title="Utilities & Access" />} />
