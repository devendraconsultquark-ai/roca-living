          ...
          <div className="relative z-10 p-14 flex flex-col h-full justify-end text-left">
            <div className="space-y-4">
              ...
              <p className="text-sidebar-text-muted text-sm leading-relaxed max-w-xs font-sans">
                Manage landlords, tenancies, maintenance, and compliance across
                the whole portfolio — all in one place.
              </p>
                ...
                {[
                  {
                    ...
                    sub: "Directories & ledgers",
                  },
                  {
                    icon: "home_work",
                    title: "Properties",
                    sub: "Portfolio & tenancies",
                  },
                  {
                    icon: "engineering",
                    title: "Maintenance",
                    sub: "Jobs, quotes & repairs",
                  },
                  {
                    icon: "verified_user",
                    title: "Compliance",
                    sub: "Certificates & inspections",
                  },
                ].map((item) => (
