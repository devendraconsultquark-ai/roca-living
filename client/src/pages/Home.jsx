...
export default function Home() {
  ...
  return (
    <div ref={container}>
      ...
      <section id="hero" className="relative min-h-[100vh] overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-40">
          <div className="max-w-4xl">
            ...
            >
              Lettings & Property Portfolio Management for UK and International
              Landlords
            </motion.p>
          </div>
        </div>
      ...
      <section className="py-24 card-bg">
        ...
        >
          <motion.div className="max-w-7xl mb-16" variants={fadeInUp}>
            <h3 className="text-3xl font-[200] mb-6 tracking-tight">
              Supporting Professional Landlords & Investors
            </h3>
            <p className="text-lg text-status-muted">
              ROCA Living provides specialist lettings and property portfolio
              management services for overseas investors with UK residential
              assets. Integrated with ROCA Estates & Management, we deliver
              coordinated building and unit-level oversight — ensuring your
              investment performs with structure, transparency and compliance.
            </p>
          </motion.div>
          ...
          >
            {[
              ...
              <motion.div
                key={i}
                className="card-bg p-10 rounded-2xl border border-card-border hover:shadow-2xl transition-all group flex flex-col h-full"
                variants={fadeInUp}
              >
      ...
      <section className="py-24 bg-background-light border-t border-card-border">
        <motion.div
          className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"
          initial="hidden"
          whileInView="visible"
        ...
        >
          ...
          >
            <div>
              <h3 className="text-3xl font-[200] tracking-tight">
                Complete Lettings, Property Management & Reporting Service​
              </h3>
            </div>
          </motion.div>
          ...
          >
            {[
              {
                title: "Lettings & Tenant Management",
                img: `${import.meta.env.BASE_URL}images/services_1.jpg`,
                slug: "lettings",
              },
              {
                title: "Financial Management & Reporting",
                img: `${import.meta.env.BASE_URL}images/services_2.jpg`,
                slug: "financial",
              },
              {
                title: "Property Portfolio Management",
                img: `${import.meta.env.BASE_URL}images/services_3.jpg`,
                slug: "portfolio",
              },
              {
                title: "Pre-Completion & Handover Support",
                img: `${import.meta.env.BASE_URL}images/services_4.jpg`,
                slug: "handover",
              },
            ].map((service, i) => (
              <motion.div key={i} variants={fadeInUp} className="h-full">
                <Link
                  ...
                  className="group relative overflow-hidden rounded-2xl card-bg flex flex-col h-full hover:shadow-xl transition-all border border-card-border"
                >
                  ...
                  <div className="p-8 flex flex-col flex-grow items-start">
                    <h4 className="text-lg lg:text-xl font-[200] leading-tight mb-8 group-hover:text-black transition-colors">
                      {service.title}
                    </h4>
        ...
        >
          <div className="rounded-3xl overflow-hidden relative">
            <div className="grid lg:grid-cols-1 gap-12 items-center relative z-10 text-center">
              <motion.div className="text-brand-primary" variants={fadeInUp}>
                <h3 className="text-3xl font-[200] mb-6 tracking-tight">
                  Professional Standards & Compliance
                </h3>
                <p className="text-lg text-status-muted mb-8 leading-relaxed">
                  ROCA Living operates with a compliance-led approach to
                  property management
                </p>
