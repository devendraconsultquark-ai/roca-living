...
export const Button = ({
  ...
  const variantStyles = {
    primary: 'bg-ink text-white hover:bg-ink-hover border border-transparent font-semibold',
    dark: 'bg-ink text-white hover:bg-ink-hover border border-transparent font-semibold',
    secondary: 'bg-white border border-card-border text-ink hover:bg-gray-50 font-semibold',
    accent: 'bg-brand-accent text-white hover:bg-brand-accent-hover border border-transparent font-semibold',
    light: 'bg-gray-50 border border-card-border text-ink hover:bg-gray-100 font-bold',
    ...
    disabled: 'bg-gray-100 text-ink-muted border-transparent font-semibold'
  };
