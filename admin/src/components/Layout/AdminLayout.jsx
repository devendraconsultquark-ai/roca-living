...
export const AdminLayout = () => {
  ...
  // Navigation configuration - All 15 sections matching the Design Guide
  const navItems = [
  ...
  const renderNavLink = (item, isMobile = false) => {
    ...
    return (
      <NavLink
        ...
        className={({ isActive }) => `
          flex items-center gap-3 px-4 py-2.5 rounded-r-lg rounded-l-none text-[14px] transition-all duration-100 group
          ${isActive 
      ...
      <div className="flex-1 flex flex-col min-w-0 h-full overflow-hidden">
        ...
        <header className="h-16 bg-white border-b border-border-color flex items-center justify-between px-4 sticky top-0 z-40 shrink-0">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* Profile Menu Link */}
            <Link to="/profile" className="flex items-center gap-2 pl-2 border-l border-border-color hover:opacity-80 transition-opacity">
