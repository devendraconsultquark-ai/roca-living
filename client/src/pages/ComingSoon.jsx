...
export const ComingSoon = ({ title }) => {
  ...
  return (
    <div className="py-12 max-w-xl mx-auto px-4 text-center flex flex-col items-center justify-center min-h-[60vh]">
      <div className="card-bg border border-card-border rounded-card p-8 shadow-premium w-full flex flex-col items-center gap-6">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-sm font-semibold text-status-info uppercase tracking-wider">
            Coming Soon
          </p>
          <p className="text-sm text-text-secondary max-w-sm mt-2 leading-relaxed">
            We are working hard to build the features for {title}. This section
