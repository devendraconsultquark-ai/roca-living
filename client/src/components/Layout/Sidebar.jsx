...
export const Sidebar = ({
            ...
            {!isCollapsedState && (
              <>
                ...
                {item.chevron === "right" && (
                  <ChevronRight
                    size={14}
                    className="ml-auto text-sidebar-text-muted group-hover:text-sidebar-text"
                  />
                )}
                {item.chevron === "down" && (
                  <ChevronDown
  ...
  return (
    <>
      ...
      <aside
        className={`hidden md:flex flex-col bg-sidebar-bg text-sidebar-text transition-all duration-300 ${collapsed ? "w-[72px]" : "w-[72px] lg:w-[240px]"} shrink-0 border-r border-sidebar-accent h-full`}
      >
        {/* Brand Header */}
        <div
          className={`h-16 flex items-center ${collapsed ? "justify-center px-4" : "justify-start px-6"} shrink-0`}
        >
        ...
        <div
          className={`flex items-center ${collapsed ? "justify-center" : "justify-end px-6"} py-2 shrink-0`}
        >
          <Button
        ...
        {!collapsed && (
          <div className="mx-4 my-3 p-4 bg-sidebar-help-bg rounded-xl border border-sidebar-accent flex flex-col gap-2.5">
            <div className="flex gap-3">
              <Headphones
                size={20}
                className="text-sidebar-text shrink-0 mt-0.5"
              />
              <div className="flex flex-col gap-1">
                <span className="text-sm-portal text-sidebar-text">
                  Need help?
                </span>
