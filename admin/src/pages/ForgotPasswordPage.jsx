...
export const ForgotPasswordPage = () => {
  ...
  const handleForgotPassword = async (e) => {
    ...
    try {
      const response = await api.post('/auth/forgot-password', { email, portal: 'admin' });
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl border border-border-color overflow-hidden">
        ...
        <form onSubmit={handleForgotPassword} className="p-8 flex flex-col gap-5">
          ...
          <p className="text-xs text-gray-500 leading-relaxed">
            Enter your registered email address below. We'll send you a link to reset your administrative portal password.
          </p>
